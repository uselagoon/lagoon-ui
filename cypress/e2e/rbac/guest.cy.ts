...
describe('GUEST permission test suites', () => {
  beforeEach(() => {
    cy.login(Cypress.env('user_guest'), Cypress.env('user_guest'));
  });
  ...
  context('Environment overview', () => {
    ...
    it('Fails to delete PROD - no permission for GUEST', () => {
      cy.visit(`${Cypress.env('url')}/projects/lagoon-demo/lagoon-demo-main`);
    ...
    it('Fails to delete any env - no permission for GUEST', () => {
  ...
  context('Deployments', () => {
    ...
    it('Fails to do a any deployment - no permission for GUEST', () => {
  ...
  context('Deployment', () => {
    it('Fails to cancel deployment - no permission for GUEST', () => {
      cy.visit(`${Cypress.env('url')}/projects/lagoon-demo/lagoon-demo-main/deployments`);
      registerIdleHandler('idle');
  ...
  context('Backups', () => {
    it('Fails to view backups - no permission to view for GUEST', () => {
  ...
  context('Tasks', () => {
    it('Fails to cancel a running task - no permission for GUEST', () => {
    ...
    it('Fails to run DB backup task - no permission for GUEST ', () => {
      cy.visit(`${Cypress.env('url')}/projects/lagoon-demo/lagoon-demo-main/tasks`);
      registerIdleHandler('idle');
    ...
    it('Fails to run DB/Files backup task - no permission for GUEST ', () => {
      cy.visit(`${Cypress.env('url')}/projects/lagoon-demo/lagoon-demo-main/tasks`);
      registerIdleHandler('idle');
    ...
    it('Fails to generate login link - no permission for GUEST ', () => {
      cy.visit(`${Cypress.env('url')}/projects/lagoon-demo/lagoon-demo-main/tasks`);
      registerIdleHandler('idle');
