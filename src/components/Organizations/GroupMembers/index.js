 ...
 */
const GroupMembers = ({ members = [], groupName, projectDefaultGroup }) => {
  ...
  return (
    ...
    <div className="deployments">
      ...
      <div key={member.user.email} className="data-row" deployment={member.user.email}>
        ...
        <div className="role"><label className={`${member.role}-label`}>{member.role}</label></div>
        <div className="remove">
        {(member.user.comment && member.user.comment.includes("autogenerated user for project") && projectDefaultGroup.includes("project") && (member.user.email.match(duRegex) != null)) || (
          <>
