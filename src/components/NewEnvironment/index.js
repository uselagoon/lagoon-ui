...
import { Footer, StyledNotification, StyledNotificationWrapper } from '../Organizations/SharedStyles';
import EnvironmentByProjectNameWithEnvVarsValueQuery
  from "../../lib/query/EnvironmentByOpenshiftProjectNameWithEnvVarsValue";
...
const NewEnvironment = ({
 ...
 refresh,
  ...
  const [
    getDeployKeyValue,
    { loading, error: dkError, data: deployKeyValue },
  ] = useLazyQuery(ProjectByNameWithDeployKeyQuery, {
        ...
        <Modal isOpen={open} onRequestClose={closeModal} contentLabel={`Confirm`} style={customStyles}>
          <React.Fragment>
            <Mutation mutation={DEPLOY_ENVIRONMENT_BRANCH_MUTATION} onError={e => console.error(e)}>
              {(deployEnvironmentBranch, { _, error, data }) => {
                if (error) {
                        ...
                        <div className="modal-step">
                          ...
                          <div className="showHideContainer">
                            <div className="copy-field">
                              ...
                              <span className="showHide" onClick={() => showDeployKey()}>
                                <Image
                          ...
                          <div className="guide-links">
                            ...
                            <div className="addEnvLinks">
                              <a href="https://docs.github.com/en/developers/overview/managing-deploy-keys#deploy-keys" target="_blank"><Button>Github</Button></a>
                              <a href="https://docs.gitlab.com/ee/user/project/deploy_keys/" target="_blank"><Button>GitLab</Button></a>
                              <a href="https://support.atlassian.com/bitbucket-cloud/docs/add-access-keys/" target="_blank"><Button>Bitbucket</Button></a>
                            </div>
                          </div>
                        </div>
                        <div className="modal-step">
                          ...
                          <p>Please ensure that all steps have been completed before creating your new environment. Follow <a href="https://docs.lagoon.sh/installing-lagoon/add-project/#add-the-deploy-key-to-your-git-repository">Lagoon Docs</a> for more details.</p>
                        </div>
                        <div>
                          <Footer>
                            <Button
